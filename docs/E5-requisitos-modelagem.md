...
### Responsabilidades
- Armazenar título, descrição, prazo, prioridade, categoria e status.
- Informar se está vencida.
...
### Responsabilidades
- Armazenar o nome da categoria e agrupar tarefas relacionadas.
...
### Responsabilidades
- Registrar cada ação realizada no sistema e permitir consulta do histórico.
...
### Responsabilidades
- Salvar tarefas em arquivo local.
